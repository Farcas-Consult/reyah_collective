      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 mb-8">
          ...
          >
            ...
            <h3 className="font-bold text-[var(--brown-800)] mb-2">Recommendations</h3>
            <p className="text-sm text-[var(--brown-700)]">Configure recommendation engine</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-bold text-[var(--brown-800)] mb-2">Seller Analytics</h3>
            <p className="text-sm text-[var(--brown-700)]">Manage seller permissions</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-bold text-[var(--brown-800)] mb-2">Localization</h3>
            <p className="text-sm text-[var(--brown-700)]">Manage languages & currencies</p>
          </Link>
